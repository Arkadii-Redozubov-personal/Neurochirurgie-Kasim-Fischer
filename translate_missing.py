...
for lang_code, google_lang in langs.items():
    ...
    for f in files:
        ...
        for orig_file in ['index.html', 'behandlungen.html', 'praxis-schwerpunkte.html', 'presseschau.html', 'sprechzeiten.html', 'unser-team.html']:
...
print("Translation of missing files completed!")
